...
Shader "MeditationModelShader"
{
	Properties
	{
		_GlowStartColor("Glow Start Color", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float4 _GlowStartColor;
		uniform float4 GlowEndColor;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_7_0 = ( float4( 0,0,0,0 ) + float4( 0,0,0,0 ) + (( ase_vertex3Pos.z > Pitch ) ? _DefaultColor :  float4( 0,0,0,0 ) ) );
			o.Albedo = temp_output_7_0.rgb;
			float temp_output_15_0 = (( Volume > 0.0 ) ? Volume :  0.0 );
			float4 lerpResult4 = lerp( _GlowStartColor , GlowEndColor , temp_output_15_0);
			o.Emission = ( (( ase_vertex3Pos.z <= Pitch ) ? lerpResult4 :  float4( 0,0,0,0 ) ) * _Float0 ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16400
-1529.6;6.4;1523;790;1239.354;200.3641;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-3180.199,-6.139603;Float;False;Global;Volume;Volume;4;0;Create;True;0;0;False;0;0;0.1258284;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;9;-3121.631,-418.1367;Float;False;Global;GlowEndColor;Glow End Color;0;0;Create;True;0;0;False;0;0,1,0,1;0.6461995,0.03380093,0.0005420544,0.4999999;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-3159.497,-679.2922;Float;False;Global;Pitch;Pitch;2;0;Create;True;0;0;False;0;-0.25;-0.2495901;-0.25;0.02;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;4;-2179.164,-556.062;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCCompareLowerEqual;3;-1691.252,-596.3622;Float;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-719.3535,383.6359;Float;False;Property;_Float0;Float 0;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-369.8299,280.8024;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1F8365A583B533A7AB06CE8B84A8BA4FFCA270C8